...
class TPakDialog(Gtk.Dialog):
    def __init__(self, parent):
        ...
        player1_rom = self.insert_entry("GB-rom-1", "Filename of the GB ROM to load into TP 1", None)
        ...
        player1_ram = self.insert_entry("GB-ram-1", "Filename of the GB RAM to load into TP 1", None)
        ...
        player2_rom = self.insert_entry("GB-rom-2", "Filename of the GB ROM to load into TP 2", None)
        ...
        player2_ram = self.insert_entry("GB-ram-2", "Filename of the GB RAM to load into TP 2", None)
        ...
        player3_rom = self.insert_entry("GB-rom-3", "Filename of the GB ROM to load into TP 2", None)
        ...
        player3_ram = self.insert_entry("GB-ram-3", "Filename of the GB RAM to load into TP 3", None)
        ...
        player4_rom = self.insert_entry("GB-rom-4", "Filename of the GB ROM to load into TP 2", None)
        ...
        player4_ram = self.insert_entry("GB-ram-4", "Filename of the GB RAM to load into TP 4", None)
